...
4.  **Confirm**: Document detailed scenarios in the **Spec File** and **Get EXPRESS USER APPROVAL** before triggering the next role.
...
**Action**:
1.  Run the **full project quality suite** (`mise run format`, `mise run lint`, and `mise run test`) to verify the new feature integrates correctly, follows style guides, and causes no regressions.
