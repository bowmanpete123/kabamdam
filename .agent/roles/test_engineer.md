...
2.  **Review Blueprint**: Read the **Spec File** (usually `specs/{unit}_spec.md`) thoroughly. This is your primary source of truth. Every scenario defined by the **Business Analyst** must have a corresponding test case.
